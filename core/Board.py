...
class Board:
    ...
    def __init__(self):
        """
        Inicializa el tablero con 24 posiciones (1 - 24), barra y home.
...
# Inicialización
    ...
    def __inicializar_posiciones__(self):
        """Coloca las fichas en la configuración inicial estándar."""
...
# Operaciones sobre posiciones
    ...
    def get_position(self, pos: int):
        """Devuelve la lista de fichas en una posición válida (1 - 24)."""
        return self.__positions__[pos] if 1 <= pos <= 24 else []

    def añadir_ficha(self, pos: int, ficha: Checker):
        """Añade una ficha en una posición válida del tablero."""
        if 1 <= pos <= 24:
...
# Representación del tablero
    ...
    def display(self):
        """
        Muestra el tablero en la terminal horizontalmente (posiciones 1 - 24).
